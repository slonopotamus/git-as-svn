[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2Fslonopotamus%2Fgit-as-svn.svg?type=shield)](https://app.fossa.com/projects/git%2Bgithub.com%2Fslonopotamus%2Fgit-as-svn?ref=badge_shield)
